...
function updateTimer() {
  const targetDate = new Date("March 2, 2025 22:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543815690721'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543815548371'; // Número para el primer botón
  const recipientNumber2 = '543816427918'; // Número para el segundo botón
  const recipientNumber3 = '543815690721'; // Número para el tercer botón
